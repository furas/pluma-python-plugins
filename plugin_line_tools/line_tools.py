...
#
# https://wiki.gnome.org/Apps/Gedit/LineToolsPlugin
#

from gi.repository import GObject, Gtk, Pluma, Peas


class LineToolsPlugin(GObject.Object, Peas.Activatable):
    ...
    def do_activate(self):
        ...
        actions = [
          ...
          ('SetBookmark3',        None, 'Set Bookmark 3',   '<Control><Shift>2', 'Set a bookmark at the current line',                                       self.set_bookmark_3),
        ...
        self._action_group = Gtk.ActionGroup("GeditLineToolsPluginActions")
        self._action_group.add_actions(actions, window)
        manager = window.get_ui_manager()
        manager.insert_action_group(self._action_group, -1)
        self._ui_id = manager.add_ui_from_string(self.line_tools_str)
